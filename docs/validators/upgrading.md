...
```
kubectl apply -f https://raw.githubusercontent.com/chronicleprotocol/charts/validator-0.3.9/charts/validator/crds/tor-controller.yaml
```
...
```
helm repo update
helm upgrade $FEED_NAME -n $FEED_NAME -f $HOME/$FEED_NAME/generated-values.yaml chronicle/validator --version 0.3.9
```
</details>
...
validator  validator       2               2025-01-06 11:52:17.003793982 -0300 -03 deployed        validator-0.3.9 0.42.2
```
