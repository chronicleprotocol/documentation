...
- [Chronicle has been selected by Centrifuge as its primary oracle partner](https://chroniclelabs.org/blog/centrifuge-selects-chronicle-as-primary-oracle-partner-for-tokenized-assets). Centrifuge empowers asset issuers to bring real-world assets onchain - tokenizing, managing, and distributing funds through a single, transparent platform. By selecting Chronicle as its oracle partner, Centrifuge leverages Chronicle Proof of Asset to verify the underlying assets and holdings-level data of tokenized funds.
- [BUIDL, tokenized by Securitize, is now verified onchain by Chronicle Proof of Asset](https://chroniclelabs.org/blog/buidl-tokenized-by-securitize-is-now-verified-onchain-by-chronicle-proof-of-asset). The BlackRock USD Institutional Digital Liquidity Fund (BUIDL) is the largest tokenized money market fund, backed by short-term U.S. Treasuries, repurchase agreements, and cash. Chronicle Proof of Asset provides independently verified holdings-level data onchain, enabling institutions, allocators, and DeFi protocols to integrate BUIDL with confidence and transparency. 
- [Chronicle provides Proof of Asset data verification for NYLIM's first tokenized fund, issued via Centrifuge](https://chroniclelabs.org/blog/chronicle-provides-proof-of-asset-data-verification-for-nylim-s-first-tokenized-fund-issued-via). New York Life Investment Management (NYLIM), which manages approximately $807 billion in assets, launched the NYLIM Anemoy U.S. High Yield Corporate Bond Segregated Portfolio  its first tokenized product and one of the first high-yield corporate bond strategies available onchain, with subscriptions and redemptions settled in USDC. Chronicle verifies portfolio composition and holdings-level data through its Proof of Asset framework. This gives institutions and DeFi platforms more granular information for evaluating the fund and managing risk. 
- [Chronicle provides Proof of Asset verification for Galaxy Digital's first tokenized CLO](https://chroniclelabs.org/blog/chronicle-provides-proof-of-asset-verification-for-galaxy-digital-s-first-tokenized-clo). Galaxy Digital brought structured credit onchain with GACLO-1, its debut tokenized collateralized loan obligation, tokenized on Avalanche and anchored by an approximately $50 million allocation from Grove. By replacing periodic disclosure with continuous, holdings-level verification, Chronicle Proof of Asset enables broader distribution for issuers and unlocks automated risk management and more capital-efficient allocation for lending platforms.
- [Chronicle powers the first onchain market for loans backed by real estate](https://chroniclelabs.org/blog/chronicle-powers-the-first-onchain-market-for-loans-backed-by-real-estate). Chronicle's Proof of Asset infrastructure is powering the first REIT-backed loans to come onchain: Groma's REIT shares, managed by Birch Hill, used as collateral for USDC loans in a Morpho market on Base. Chronicle reports the data from Groma's property portfolio, fund assets, and liabilities as onchain data that Morpho's liquidation infrastructure and Birch Hill's risk parameters can operate against.