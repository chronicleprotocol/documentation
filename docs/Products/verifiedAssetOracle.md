...
- Chronicle announced that its Verified Asset Oracle (VAO) technology is [enabling all winners of the Spark $1 Billion Tokenization Grand Prix to verify and manage their tokenized assets](https://chroniclelabs.org/blog/chronicle-powers-grand-prix-winners-with-innovative-verified-asset-oracle-technology). BlackRock’s BUIDL, Superstate, and Centrifuge were named as the winners of the Spark Tokenization Grand Prix, securing allocations from Sky’s planned $1 Billion investment in tokenized real-world assets.
