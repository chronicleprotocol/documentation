...
You can provide these variables with `.env` as well Take a look at [this](quickstart.md#install-with-.env) section. The installer will create kubernetes secrets that are used in the helm release and feed services.
